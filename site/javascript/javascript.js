...
function tradeLoadFill(){
    ...
    cont+="<input type='text' name='amount' placeholder='Amount'></input>";
    cont+="<btn onclick='tryFillOrder()'>FILL ORDER</btn></div>";
    $(".place").html(cont);
}
...
function disableScrolls(){
    $(".sellscontent").mCustomScrollbar("destroy");
    $(".buyscontent").mCustomScrollbar("destroy");
    $(".marketscontent").mCustomScrollbar("destroy");
    $(".historycontent").mCustomScrollbar("destroy");
    $(".orderscontent").mCustomScrollbar("destroy");
}
